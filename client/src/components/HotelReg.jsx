        ...
        <form action="" className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
            ...
            <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
                ...
                <div className='w-full mt-4'>
                    ...
                    <input type="text" placeholder='Type here' className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outline-indigo-500 font-light'required/>
                </div>
                {/* COntact  */}
                ...
                <div className='w-full mt-4 max-w-60 mr-auto'>
                    <label htmlFor="city" className='font-medium text-gray-500 mt-4'>City</label>
                ...
                <button className='bg-indigo-500 hover:bg-indigo-600  trasnsition-all text-white mr-auto px-6 py-2 rounded cursor-pointer mt-6'>Register</button>
            </div>
        </form>
    </div>
  )
