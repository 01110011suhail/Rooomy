...
const AllRooms = () => {
  ...
  <div className="flex flex-col lg:w-3/4">
    ...
    {/* Filters for Mobile (shown only on small screens) */}
    <div className="lg:hidden mb-6 bg-white border border-gray-300 text-gray-600 p-4 rounded-lg">
      <div className="flex justify-between items-center mb-2">
        <p className="text-base font-medium text-gray-800">FILTERS</p>
        <span className="text-xs cursor-pointer">HIDE</span>
      </div>
  ...
  <div className="hidden lg:block lg:w-1/4 bg-white border border-gray-300 text-gray-600 p-4 rounded-lg">
    <div className="flex justify-between items-center mb-2">
      <p className="text-base font-medium text-gray-800">FILTERS</p>
      <span className="text-xs cursor-pointer">CLEAR</span>
    </div>
    {/* Add desktop filter content here */}
  </div>
