...
const ListRoom = () => {
  ...
  return (
    <div>
      <Title align='left' font='outfit' title='Room Listings' subTitle='View, edit, or manage all listed rooms. keep the information up-to-date to provide the best experince for users.'/>
              ...
              <tr key={index}>
                ...
                <td className='py-3 px-4 text-gray-700 border-t border-gray-300 text-sm text-red-500 text-center'>
                  <label htmlFor='' className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                    ...
                    <div className='w-12 h-7 bg-slate-300 rounded-full peer peer-checked:bg-blue-600 transistion-colors duration-200'></div>
